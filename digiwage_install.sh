...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='digiwage.conf'
CONFIGFOLDER='/root/.digiwage'
COIN_DAEMON='digiwaged'
COIN_CLI='digiwage-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/digiwage/digiwage/releases/download/v1.1.0/digiwage-1.1.0-x86_64-linux-gnu.tar.gz'
